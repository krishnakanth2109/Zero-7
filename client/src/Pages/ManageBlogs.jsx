  ...
  return (
    <div className='flex flex-col items-center p-4'>
      ...
      <div className='w-full max-w-5xl mt-12'>
        <h3 className='text-2xl font-semibold mb-4 border-b pb-2'>Existing Posts</h3>
          ...
          {blogs.map((blog) => (
            <div key={blog._id} className='bg-white shadow-lg rounded-lg overflow-hidden flex flex-col'>
              ...
              <div className='p-4 flex flex-col flex-grow'>
                ...
                <p className='text-sm text-gray-600 flex-grow h-16 overflow-hidden'>{blog.description}</p>
