...
import { AudioLines, CardSim, ChevronDown, CircleUser, GraduationCap, HardDrive, LayoutDashboard, LogOut, Shield, Store, UserRound } from "lucide-react";
    ...
    <aside className="admin-sidebar">
      <div>
        ...
        <nav>
          ...
          >
            <div className="dashboard-icon"><LayoutDashboard style={{width:'18px'}} /> Dashboard </div>
          </Link>
          <div className="dropdown-container">
            ...
            >
              <div className="dashboard-icon"><HardDrive style={{width:'18px'}} /> Services </div>
              <ChevronDown
                size={18}
          ...
          >
            <div className="dashboard-icon"><CircleUser style={{width:'18px'}} /> Manage Jobs </div>
          </Link>
          <Link
          ...
          >
            <div className="dashboard-icon"><Store style={{width:'18px'}} />View Applications </div>
          </Link>
          <Link
          ...
          >
            <div className="dashboard-icon"><GraduationCap style={{width:'18px'}} />New Batches </div>
          </Link>
          <Link
          ...
          >
            <div className="dashboard-icon"><Shield style={{width:'18px'}} />Manage Blogs </div>
          </Link>
          <Link
        ...
        >
          ...
          <div className="dashboard-icon"><UserRound style={{width:'18px'}} />Manage Candidates </div>
        </Link>
        <Link
