      ...
      <div className='testimonial-section'>
        ...
        <div className='testimonial-grid'>
          ...
          <div className='testimonial-card' style={{ animationDelay: '0.1s' }}>
            ...
            <div className='testimonial-content'>
              <p className='testimonial-text' >
                Partnering with Zero7 Technologies has been transformative. Their technical excellence and forward-thinking approach consistently exceed expectations. We look forward to continuing this successful collaboration.
              </p>
          ...
          <div className='testimonial-card' style={{ animationDelay: '0.2s' }}>
            ...
            <div className='testimonial-content'>
              <p className='testimonial-text'>
                Zero7 Technologies has streamlined our hiring process. Their well-prepared, pre-screened candidates have cut our recruitment time by nearly half. their understanding and deliver makes a trusted talent partner
              </p>
              <div className='testimonial-author'>
          ...
          <div className='testimonial-card' style={{ animationDelay: '0.3s' }}>
            ...
            <div className='testimonial-content'>
              <p className='testimonial-text'>
                Training students at Zero7 Technologies has been highly rewarding. Their hands-on, structured approach helps students master complex AI/ML concepts and apply them confidently.
              </p>
              <div className='testimonial-author'>
          ...
          <div className='testimonial-card' style={{ animationDelay: '0.3s' }}>
            ...
            <div className='testimonial-content'>
              <p className='testimonial-text'>
                My experience at Zero7 Technologies has been truly transformative. The structured training and hands-on projects helped me master data analysis tools and techniques, boosting both my confidence and practical skills.
              </p>
              <div className='testimonial-author'>
