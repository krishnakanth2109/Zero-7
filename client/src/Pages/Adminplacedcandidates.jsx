...
import { FaUserTie, FaBuilding, FaBriefcase, FaCalendarAlt, FaCheckCircle } from 'react-icons/fa' // Importing icons
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100">
        <div className="text-center p-8 bg-white rounded-lg shadow-xl">
          ...
          <p className="text-lg text-gray-700 font-semibold">Loading placed candidates...</p>
        </div>
      </div>
    )
  }
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    <p className="flex items-center text-gray-700">
                      ...
                      <span className="font-semibold">Company:</span> {candidate.companyName}
                    </p>
                    <p className="flex items-center text-gray-700">
                      <FaBriefcase className="text-teal-400 mr-3" />
                      <span className="font-semibold">Job Role:</span> {candidate.jobRole}
                    </p>
                    <p className="flex items-center text-gray-700">
                      <FaCheckCircle className="text-green-500 mr-3" />
                      <span className="font-semibold">Level:</span> {candidate.interviewLevel}
                    </p>
                    <p className="flex items-center text-gray-700">
